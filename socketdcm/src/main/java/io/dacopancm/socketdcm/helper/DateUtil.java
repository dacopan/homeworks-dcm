...
public class DateUtil {
    ...
    private static final String DATE_PATTERN2 = "ddMMyyyykms";
    ...
    public static String nowDateJoined() {
        return DATE_FORMATTER2.format(LocalDateTime.now());
    }

    /**
     * Converts a String in the format of the defined
     * {@link DateUtil#DATE_PATTERN} to a {@link LocalDateTime} object.
     *
