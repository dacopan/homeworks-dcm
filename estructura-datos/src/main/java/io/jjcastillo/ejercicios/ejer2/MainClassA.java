...
public class MainClassA {
    ...
    private void agregarAction() {
        ...
        if (ventanillaA.contiene(cliente) || ventanillaB.contiene(cliente)) {
            ...
            if (isSegundaVentanillaActiva && cliente.getEdad() >= 65) {
    ...
    private void imprimirAction() {
        ...
        if (isSegundaVentanillaActiva) {
            System.out.println("╔═════════════════════════════╗");
            System.out.println("║   Ventanilla 3ra Edad       ║");
            System.out.println("╚═════════════════════════════╝");
            System.out.println("");
    ...
    private void newVentanillaAction() {
        if (isSegundaVentanillaActiva) {
            ...
            Cola colaB = ventanillaA.getClientesTerceraEdad();

            System.out.printf("%nClientes movidos de %15s a %s : %5d%n", "Ventanilla A", "Ventanilla 3ra edad", colaB.getTamano());
    ...
    private void atenderAction() {
        ...
        if (isSegundaVentanillaActiva) {
            System.out.println("        2. " + "Ventanilla 3ra Edad");
        }
