 ...
 * @website http://dacopancm.hol.es/blog/about .
 * @description DesktopApi based on original Java API and modifiers
 * stackoverflow post NO DOCUMENT because methods are evidents and exactly de
 * original Desktop Api of java
 */
